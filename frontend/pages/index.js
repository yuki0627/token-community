...
export default function Home() {
  ...
  const hoge = async () => {
    let log = await alchemy.nft.getNftMetadata(
      "0x3C615Ff54EA197AaE70dF0df15517dDC680B0C1D",
      "1"
    )
    console.log('log.tokenUri.raw:', log.tokenUri.raw);
    return log.tokenUri.raw;
  }
  ...
  return (
    <div className={'flex flex-col items-center bg-slate-100 text-blue-900 min-h-screen'}>
      ...
      <img src="data:image/svg+xml;base64," />
